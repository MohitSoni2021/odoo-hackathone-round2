    ...
    >
      <div className="flex flex-col">
        ...
        <div className="p-8">
          ...
          <a href={"https://www.google.com/maps/search/?api=1&query="+details?.name+details?.location} className="block mt-1 text-lg leading-tight font-medium text-black hover:text-indigo-500">{details?.name || "Generic Travel Spot"}</a>
